...
Requires: elfutils-libelf kernel = 4.12.0 kernel-headers = 4.12.0 kernel-devel = 4.12.0
%description -n libbcc
Shared Library for BPF Compiler Collection (BCC)

%package -n python-bcc
Summary: Python bindings for BPF Compiler Collection (BCC)
Requires: libbcc = %{version}-%{release} kernel = 4.12.0 kernel-headers = 4.12.0 kernel-devel = 4.12.0
...
Requires: python-bcc = %{version}-%{release} kernel = 4.12.0 kernel-headers = 4.12.0 kernel-devel = 4.12.0
%if %{with_lua}
...
%post -n bcc-tools 
mv /lib/modules/4.12.0-estuary.1.aarch64 /lib/modules/4.12.0
