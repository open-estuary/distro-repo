...
Requires: devtoolset-4-compiler-rt%{?_isa} >= %{version}
...
Requires: devtoolset-4-llvm-libs%{?_isa} = %{version}
Requires: devtoolset-4-clang-libs%{?_isa} = %{version}
...
%cmake3 .. \
	...
	-DLLVM_CONFIG:FILEPATH=/opt/rh/devtoolset-4/root/usr/bin/llvm-config-%{__isa_bits} \
	\
...
#cmake3 .. -DCMAKE_C_COMPILER=%{buildroot}%{_bindir}/clang \
#         -DCMAKE_CXX_COMPILER=%{buildroot}%{_bindir}/clang++
