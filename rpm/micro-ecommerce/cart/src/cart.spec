...
Summary:        cart jar
License:        GPL-2.0
Source:         https://github.com/zhouxingchen1993/discovery.git/cart-1.0.tar.gz
...
tar -zcvf %{name}-%{version}-jar.tar.gz %{name}-%{version}/cart-service/target
...
- create cart service 1.0 rpm package
