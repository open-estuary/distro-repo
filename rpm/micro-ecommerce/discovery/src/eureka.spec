...
Summary:        eureka jar
License:        GPL-2.0
Source:         https://github.com/zhouxingchen1993/discovery.git/eureka-1.0.tar.gz
...
tar -zcvf %{name}-%{version}-jar.tar.gz %{name}-%{version}/discovery-service/target
...
- create discovery service 1.0 rpm package
