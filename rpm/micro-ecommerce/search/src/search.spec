...
Summary:        search jar
License:        GPL-2.0
Source:         https://github.com/zhouxingchen1993/discovery.git/search-1.0.tar.gz
...
tar -zcvf %{name}-%{version}-jar.tar.gz %{name}-%{version}/search-service/target
...
- create search service 1.0 rpm package
