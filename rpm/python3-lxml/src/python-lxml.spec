...
%changelog
* Thu May 18 2017 Huang Jinhua <sjtuhjh@hotmail.com> 3.7.2
- Initial packages for Estuary ARM64 platform
...
- Add requirement for on python-cssselect for the python version
